      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-center">
        <div class="flex items-center justify-between w-full">
          ...
          <div class="flex items-center">
            <a href="/">
              <p class="text-3xl font-bold">Daemonlite..</p>
            </a>
          ...
          <div class="hidden md:flex md:ml-auto">
            <div class="flex flex-col md:flex-row md:mx-1 mr-0">
              <router-link
                :to="{name:'landing'}"
                class="my-2 text-md leading-5 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0"
        ...
        <div
          :class="[isOpen ? 'block' : 'hidden', 'lg:hidden']"
